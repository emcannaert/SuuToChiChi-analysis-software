def return_BR_SF(year=None,sample=None):
	...
	if year == None and sample==None:
		...
		if "QCD" in sample:
			...
			if  "WJetsMC_QQ-HT800toInf"      in sample: scale_factor = scale_factors["WJetsMC_QQ-HT800toInf"][year]
			elif  "WJetsMC_LNu-HT800to1200"  in sample: scale_factor = scale_factors["WJetsMC_LNu-HT800to1200"][year]
			elif  "WJetsMC_LNu-HT1200to2500" in sample: scale_factor = scale_factors["WJetsMC_LNu-HT1200to2500"][year]
			elif  "WJetsMC_LNu-HT2500toInf"  in sample: scale_factor = scale_factors["WJetsMC_LNu-HT2500toInf"][year]
