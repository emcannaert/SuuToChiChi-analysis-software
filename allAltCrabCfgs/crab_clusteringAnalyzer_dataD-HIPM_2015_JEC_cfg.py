...
config = config()
config.General.requestName = 'clustAlg_dataD-HIPM_2015_JEC_AltDatasets_000'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.JobType.allowUndistributedCMSSW = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '../allCfgs/clusteringAnalyzer_dataD-HIPM_2015_JEC_cfg.py'
...
config.Data.outputDatasetTag = 'clustAlg_dataD-HIPM_2015_JEC'
