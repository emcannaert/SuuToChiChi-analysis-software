...
config = config()
config.General.requestName = 'clustAlg_ST_tW-top_inclMC_2018_JER_AltDatasets_000'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.JobType.allowUndistributedCMSSW = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '../allCfgs/clusteringAnalyzer_ST_tW-top_inclMC_2018_JER_cfg.py'
...
config.Data.outputDatasetTag = 'clustAlg_ST_tW-top_inclMC_2018_JER'
