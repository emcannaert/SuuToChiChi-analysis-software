...
config = config()
config.General.requestName = 'clustAlg_QCDMC2000toInf_2017_nom_AltDatasets_000'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.JobType.allowUndistributedCMSSW = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '../allCfgs/clusteringAnalyzer_QCDMC2000toInf_2017_cfg.py'
...
config.Data.outputDatasetTag = 'clustAlg_QCDMC2000toInf_2017_nom'
