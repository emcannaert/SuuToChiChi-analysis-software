...
config = config()
config.General.requestName = 'clustAlg_ST_s-channel-hadronsMC_2016_nom_AltDatasets_000'
...
config.Data.outputDatasetTag = 'clustAlg_ST_s-channel-hadronsMC_2016_nom'
