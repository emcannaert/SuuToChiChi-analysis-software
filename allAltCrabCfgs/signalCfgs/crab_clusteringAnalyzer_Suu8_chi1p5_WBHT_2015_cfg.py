...
config = config()
config.General.requestName = 'clustAlg_Suu8_chi1p5_WBHT_2015_nom_AltDatasets_000'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.JobType.allowUndistributedCMSSW = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '../../allCfgs/signalCfgs/clusteringAnalyzer_Suu8_chi1p5_WBHT_2015_cfg.py'
...
config.Data.outputDatasetTag = 'clustAlg_Suu8_chi1p5_WBHT_2015_nom'
