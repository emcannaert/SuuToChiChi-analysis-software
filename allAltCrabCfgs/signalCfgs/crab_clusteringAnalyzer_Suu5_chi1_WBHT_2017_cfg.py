...
config = config()
config.General.requestName = 'clustAlg_Suu5_chi1_WBHT_2017_nom_AltDatasets_000'
config.General.workArea = 'crab_projects_sideband'
config.General.transferOutputs = True
config.JobType.allowUndistributedCMSSW = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '../../allCfgs/signalCfgs/clusteringAnalyzer_Suu5_chi1_WBHT_2017_cfg.py'
...
config.Data.outputDatasetTag = 'clustAlg_Suu5_chi1_WBHT_2017_nom'
