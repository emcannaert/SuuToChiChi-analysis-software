...
config = config()
config.General.requestName = 'clustAlg_QCDMC1500to2000_2017_JER_AltDatasets_000'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.JobType.allowUndistributedCMSSW = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '../allCfgs/clusteringAnalyzer_QCDMC1500to2000_2017_JER_cfg.py'
...
config.Data.outputDatasetTag = 'clustAlg_QCDMC1500to2000_2017_JER'
