...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/mc/RunIISummer20UL16MiniAODv2/QCD_HT1000to1500_TuneCP5_PSWeights_13TeV-madgraphMLM-pythia8/MINIAODSIM/106X_mcRun2_asymptotic_v17-v1/110000/17418062-EBE8-C947-8950-E797EC69F62B.root')
)
...
process.clusteringAnalyzerAll_JEC_AbsoluteMPFBias_down = cms.EDAnalyzer("clusteringAnalyzerAll",
    ...
    JECUncert_AK4_path = cms.FileInPath('data/JEC/2016_UL_postAPV/MC/Summer19UL16_V7_MC_Uncertainty_AK4PFchs.txt'),
    JECUncert_AK8_path = cms.FileInPath('data/JEC/2016_UL_postAPV/MC/Summer19UL16_V7_MC_Uncertainty_AK8PFPuppi.txt'),
    PUfile_path = cms.FileInPath('data/POG/LUM/2016postVFP_UL/puWeights.json'),
    bTagEff_path = cms.FileInPath('data/btaggingEffMaps/btag_efficiency_map_QCDMC_combined_2016.root'),
    bTagSF_path = cms.FileInPath('data/bTaggingSFs/2016postVFP_UL/btagging.json'),
    ...
    runType = cms.string('QCDMC1000to1500'),
    slimmedSelection = cms.bool(True),
    systematicType = cms.string('JEC_AbsoluteMPFBias_down'),
    tauCollection = cms.InputTag("slimmedTaus"),
...
process.clusteringAnalyzerAll_JEC_AbsoluteMPFBias_up = cms.EDAnalyzer("clusteringAnalyzerAll",
    BESTname = cms.string('BESTGraph'),
    BESTpath = cms.FileInPath('data/BEST_models/constantgraph_2016.pb'),
    BESTscale = cms.FileInPath('data/BESTScalerParameters_all_mass_2016.txt'),
    JECUncert_AK4_path = cms.FileInPath('data/JEC/2016_UL_postAPV/MC/Summer19UL16_V7_MC_Uncertainty_AK4PFchs.txt'),
    ...
    runType = cms.string('QCDMC1000to1500'),
    slimmedSelection = cms.bool(True),
    systematicType = cms.string('JEC_AbsoluteMPFBias_up'),
    tauCollection = cms.InputTag("slimmedTaus"),
    triggers = cms.string('HLT_PFHT900_v'),
    verbose = cms.bool(False),
    year = cms.string('2016')
...
process.clusteringAnalyzerAll_JEC_AbsoluteScale_down = cms.EDAnalyzer("clusteringAnalyzerAll",
    BESTname = cms.string('BESTGraph'),
    BESTpath = cms.FileInPath('data/BEST_models/constantgraph_2016.pb'),
    BESTscale = cms.FileInPath('data/BESTScalerParameters_all_mass_2016.txt'),
    JECUncert_AK4_path = cms.FileInPath('data/JEC/2016_UL_postAPV/MC/Summer19UL16_V7_MC_Uncertainty_AK4PFchs.txt'),
    ...
    runType = cms.string('QCDMC1000to1500'),
    slimmedSelection = cms.bool(True),
    systematicType = cms.string('JEC_AbsoluteScale_down'),
    tauCollection = cms.InputTag("slimmedTaus"),
    triggers = cms.string('HLT_PFHT900_v'),
    verbose = cms.bool(False),
    year = cms.string('2016')
...
process.clusteringAnalyzerAll_JEC_AbsoluteScale_up = cms.EDAnalyzer("clusteringAnalyzerAll",
    BESTname = cms.string('BESTGraph'),
    BESTpath = cms.FileInPath('data/BEST_models/constantgraph_2016.pb'),
    BESTscale = cms.FileInPath('data/BESTScalerParameters_all_mass_2016.txt'),
    JECUncert_AK4_path = cms.FileInPath('data/JEC/2016_UL_postAPV/MC/Summer19UL16_V7_MC_Uncertainty_AK4PFchs.txt'),
    ...
    runType = cms.string('QCDMC1000to1500'),
    slimmedSelection = cms.bool(True),
    systematicType = cms.string('JEC_AbsoluteScale_up'),
    tauCollection = cms.InputTag("slimmedTaus"),
    triggers = cms.string('HLT_PFHT900_v'),
    verbose = cms.bool(False),
    year = cms.string('2016')
...
process.clusteringAnalyzerAll_JEC_AbsoluteTheory_down = cms.EDAnalyzer("clusteringAnalyzerAll",
    BESTname = cms.string('BESTGraph'),
    BESTpath = cms.FileInPath('data/BEST_models/constantgraph_2016.pb'),
    BESTscale = cms.FileInPath('data/BESTScalerParameters_all_mass_2016.txt'),
    JECUncert_AK4_path = cms.FileInPath('data/JEC/2016_UL_postAPV/MC/Summer19UL16_V7_MC_Uncertainty_AK4PFchs.txt'),
    ...
    runType = cms.string('QCDMC1000to1500'),
    slimmedSelection = cms.bool(True),
    systematicType = cms.string('JEC_AbsoluteTheory_down'),
    tauCollection = cms.InputTag("slimmedTaus"),
    triggers = cms.string('HLT_PFHT900_v'),
    verbose = cms.bool(False),
    year = cms.string('2016')
...
process.clusteringAnalyzerAll_JEC_AbsoluteTheory_up = cms.EDAnalyzer("clusteringAnalyzerAll",
    BESTname = cms.string('BESTGraph'),
    BESTpath = cms.FileInPath('data/BEST_models/constantgraph_2016.pb'),
    BESTscale = cms.FileInPath('data/BESTScalerParameters_all_mass_2016.txt'),
    JECUncert_AK4_path = cms.FileInPath('data/JEC/2016_UL_postAPV/MC/Summer19UL16_V7_MC_Uncertainty_AK4PFchs.txt'),
    ...
    runType = cms.string('QCDMC1000to1500'),
    slimmedSelection = cms.bool(True),
    systematicType = cms.string('JEC_AbsoluteTheory_up'),
    tauCollection = cms.InputTag("slimmedTaus"),
    triggers = cms.string('HLT_PFHT900_v'),
    verbose = cms.bool(False),
    year = cms.string('2016')
...
process.clusteringAnalyzerAll_JEC_BBEC1_year_down = cms.EDAnalyzer("clusteringAnalyzerAll",
    BESTname = cms.string('BESTGraph'),
    BESTpath = cms.FileInPath('data/BEST_models/constantgraph_2016.pb'),
    BESTscale = cms.FileInPath('data/BESTScalerParameters_all_mass_2016.txt'),
    JECUncert_AK4_path = cms.FileInPath('data/JEC/2016_UL_postAPV/MC/Summer19UL16_V7_MC_Uncertainty_AK4PFchs.txt'),
    ...
    runType = cms.string('QCDMC1000to1500'),
    slimmedSelection = cms.bool(True),
    systematicType = cms.string('JEC_BBEC1_year_down'),
    tauCollection = cms.InputTag("slimmedTaus"),
    triggers = cms.string('HLT_PFHT900_v'),
    verbose = cms.bool(False),
    year = cms.string('2016')
...
process.clusteringAnalyzerAll_JEC_BBEC1_year_up = cms.EDAnalyzer("clusteringAnalyzerAll",
    BESTname = cms.string('BESTGraph'),
    BESTpath = cms.FileInPath('data/BEST_models/constantgraph_2016.pb'),
    BESTscale = cms.FileInPath('data/BESTScalerParameters_all_mass_2016.txt'),
    JECUncert_AK4_path = cms.FileInPath('data/JEC/2016_UL_postAPV/MC/Summer19UL16_V7_MC_Uncertainty_AK4PFchs.txt'),
    ...
    runType = cms.string('QCDMC1000to1500'),
    slimmedSelection = cms.bool(True),
    systematicType = cms.string('JEC_BBEC1_year_up'),
    tauCollection = cms.InputTag("slimmedTaus"),
    triggers = cms.string('HLT_PFHT900_v'),
    verbose = cms.bool(False),
    year = cms.string('2016')
...
process.clusteringAnalyzerAll_JEC_FlavorQCD_down = cms.EDAnalyzer("clusteringAnalyzerAll",
    BESTname = cms.string('BESTGraph'),
    BESTpath = cms.FileInPath('data/BEST_models/constantgraph_2016.pb'),
    BESTscale = cms.FileInPath('data/BESTScalerParameters_all_mass_2016.txt'),
    JECUncert_AK4_path = cms.FileInPath('data/JEC/2016_UL_postAPV/MC/Summer19UL16_V7_MC_Uncertainty_AK4PFchs.txt'),
    ...
    runType = cms.string('QCDMC1000to1500'),
    slimmedSelection = cms.bool(True),
    systematicType = cms.string('JEC_FlavorQCD_down'),
    tauCollection = cms.InputTag("slimmedTaus"),
    triggers = cms.string('HLT_PFHT900_v'),
    verbose = cms.bool(False),
    year = cms.string('2016')
...
process.clusteringAnalyzerAll_JEC_FlavorQCD_up = cms.EDAnalyzer("clusteringAnalyzerAll",
    BESTname = cms.string('BESTGraph'),
    BESTpath = cms.FileInPath('data/BEST_models/constantgraph_2016.pb'),
    BESTscale = cms.FileInPath('data/BESTScalerParameters_all_mass_2016.txt'),
    JECUncert_AK4_path = cms.FileInPath('data/JEC/2016_UL_postAPV/MC/Summer19UL16_V7_MC_Uncertainty_AK4PFchs.txt'),
    ...
    runType = cms.string('QCDMC1000to1500'),
    slimmedSelection = cms.bool(True),
    systematicType = cms.string('JEC_FlavorQCD_up'),
    tauCollection = cms.InputTag("slimmedTaus"),
    triggers = cms.string('HLT_PFHT900_v'),
    verbose = cms.bool(False),
    year = cms.string('2016')
...
process.clusteringAnalyzerAll_JEC_Fragmentation_down = cms.EDAnalyzer("clusteringAnalyzerAll",
    BESTname = cms.string('BESTGraph'),
    BESTpath = cms.FileInPath('data/BEST_models/constantgraph_2016.pb'),
    BESTscale = cms.FileInPath('data/BESTScalerParameters_all_mass_2016.txt'),
    JECUncert_AK4_path = cms.FileInPath('data/JEC/2016_UL_postAPV/MC/Summer19UL16_V7_MC_Uncertainty_AK4PFchs.txt'),
    ...
    runType = cms.string('QCDMC1000to1500'),
    slimmedSelection = cms.bool(True),
    systematicType = cms.string('JEC_Fragmentation_down'),
    tauCollection = cms.InputTag("slimmedTaus"),
    triggers = cms.string('HLT_PFHT900_v'),
    verbose = cms.bool(False),
    year = cms.string('2016')
...
process.clusteringAnalyzerAll_JEC_Fragmentation_up = cms.EDAnalyzer("clusteringAnalyzerAll",
    BESTname = cms.string('BESTGraph'),
    BESTpath = cms.FileInPath('data/BEST_models/constantgraph_2016.pb'),
    BESTscale = cms.FileInPath('data/BESTScalerParameters_all_mass_2016.txt'),
    JECUncert_AK4_path = cms.FileInPath('data/JEC/2016_UL_postAPV/MC/Summer19UL16_V7_MC_Uncertainty_AK4PFchs.txt'),
    ...
    runType = cms.string('QCDMC1000to1500'),
    slimmedSelection = cms.bool(True),
    systematicType = cms.string('JEC_Fragmentation_up'),
    tauCollection = cms.InputTag("slimmedTaus"),
    triggers = cms.string('HLT_PFHT900_v'),
    verbose = cms.bool(False),
    year = cms.string('2016')
...
process.clusteringAnalyzerAll_JEC_RelativeBal_down = cms.EDAnalyzer("clusteringAnalyzerAll",
    BESTname = cms.string('BESTGraph'),
    BESTpath = cms.FileInPath('data/BEST_models/constantgraph_2016.pb'),
    BESTscale = cms.FileInPath('data/BESTScalerParameters_all_mass_2016.txt'),
    JECUncert_AK4_path = cms.FileInPath('data/JEC/2016_UL_postAPV/MC/Summer19UL16_V7_MC_Uncertainty_AK4PFchs.txt'),
    ...
    runType = cms.string('QCDMC1000to1500'),
    slimmedSelection = cms.bool(True),
    systematicType = cms.string('JEC_RelativeBal_down'),
    tauCollection = cms.InputTag("slimmedTaus"),
    triggers = cms.string('HLT_PFHT900_v'),
    verbose = cms.bool(False),
    year = cms.string('2016')
...
process.clusteringAnalyzerAll_JEC_RelativeBal_up = cms.EDAnalyzer("clusteringAnalyzerAll",
    BESTname = cms.string('BESTGraph'),
    BESTpath = cms.FileInPath('data/BEST_models/constantgraph_2016.pb'),
    BESTscale = cms.FileInPath('data/BESTScalerParameters_all_mass_2016.txt'),
    JECUncert_AK4_path = cms.FileInPath('data/JEC/2016_UL_postAPV/MC/Summer19UL16_V7_MC_Uncertainty_AK4PFchs.txt'),
    ...
    runType = cms.string('QCDMC1000to1500'),
    slimmedSelection = cms.bool(True),
    systematicType = cms.string('JEC_RelativeBal_up'),
    tauCollection = cms.InputTag("slimmedTaus"),
    triggers = cms.string('HLT_PFHT900_v'),
    verbose = cms.bool(False),
    year = cms.string('2016')
...
process.clusteringAnalyzerAll_JEC_RelativeFSR_down = cms.EDAnalyzer("clusteringAnalyzerAll",
    BESTname = cms.string('BESTGraph'),
    BESTpath = cms.FileInPath('data/BEST_models/constantgraph_2016.pb'),
    BESTscale = cms.FileInPath('data/BESTScalerParameters_all_mass_2016.txt'),
    JECUncert_AK4_path = cms.FileInPath('data/JEC/2016_UL_postAPV/MC/Summer19UL16_V7_MC_Uncertainty_AK4PFchs.txt'),
    ...
    runType = cms.string('QCDMC1000to1500'),
    slimmedSelection = cms.bool(True),
    systematicType = cms.string('JEC_RelativeFSR_down'),
    tauCollection = cms.InputTag("slimmedTaus"),
    triggers = cms.string('HLT_PFHT900_v'),
    verbose = cms.bool(False),
    year = cms.string('2016')
...
process.clusteringAnalyzerAll_JEC_RelativeFSR_up = cms.EDAnalyzer("clusteringAnalyzerAll",
    BESTname = cms.string('BESTGraph'),
    BESTpath = cms.FileInPath('data/BEST_models/constantgraph_2016.pb'),
    BESTscale = cms.FileInPath('data/BESTScalerParameters_all_mass_2016.txt'),
    JECUncert_AK4_path = cms.FileInPath('data/JEC/2016_UL_postAPV/MC/Summer19UL16_V7_MC_Uncertainty_AK4PFchs.txt'),
    ...
    runType = cms.string('QCDMC1000to1500'),
    slimmedSelection = cms.bool(True),
    systematicType = cms.string('JEC_RelativeFSR_up'),
    tauCollection = cms.InputTag("slimmedTaus"),
    triggers = cms.string('HLT_PFHT900_v'),
    verbose = cms.bool(False),
    year = cms.string('2016')
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('clusteringAnalyzer_QCDMC1000to1500_2016_JEC1_output.root')
)
...
process.p = cms.Path(process.pileupJetIdUpdated+process.leptonVeto+process.prefiringweight+process.clusteringAnalyzerAll_JEC_FlavorQCD_up+process.clusteringAnalyzerAll_JEC_FlavorQCD_down+process.clusteringAnalyzerAll_JEC_RelativeBal_up+process.clusteringAnalyzerAll_JEC_RelativeBal_down+process.clusteringAnalyzerAll_JEC_BBEC1_year_up+process.clusteringAnalyzerAll_JEC_BBEC1_year_down+process.clusteringAnalyzerAll_JEC_AbsoluteScale_up+process.clusteringAnalyzerAll_JEC_AbsoluteScale_down+process.clusteringAnalyzerAll_JEC_Fragmentation_up+process.clusteringAnalyzerAll_JEC_Fragmentation_down+process.clusteringAnalyzerAll_JEC_AbsoluteMPFBias_up+process.clusteringAnalyzerAll_JEC_AbsoluteMPFBias_down+process.clusteringAnalyzerAll_JEC_RelativeFSR_up+process.clusteringAnalyzerAll_JEC_RelativeFSR_down+process.clusteringAnalyzerAll_JEC_AbsoluteTheory_up+process.clusteringAnalyzerAll_JEC_AbsoluteTheory_down)
