...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/mc/RunIISummer20UL16MiniAODv2/QCD_HT2000toInf_TuneCP5_PSWeights_13TeV-madgraphMLM-pythia8/MINIAODSIM/106X_mcRun2_asymptotic_v17-v1/120000/3517E0D8-3968-9240-B445-4DBB5CD69DBE.root')
)
...
process.clusteringAnalyzerAll_JEC_AbsoluteMPFBias_down = cms.EDAnalyzer("clusteringAnalyzerAll",
    ...
    runType = cms.string('QCDMC2000toInf'),
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('clusteringAnalyzer_QCDMC2000toInf_2016_JEC1_output.root')
)
