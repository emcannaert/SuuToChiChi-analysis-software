...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/mc/RunIISummer20UL16MiniAODv2/QCD_HT1500to2000_TuneCP5_PSWeights_13TeV-madgraphMLM-pythia8/MINIAODSIM/106X_mcRun2_asymptotic_v17-v1/110000/2DF4DD91-8FF2-AE45-AE33-40048C9E3E75.root')
)
...
process.clusteringAnalyzerAll_JEC_AbsoluteMPFBias_down = cms.EDAnalyzer("clusteringAnalyzerAll",
    ...
    runType = cms.string('QCDMC1500to2000'),
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('clusteringAnalyzer_QCDMC1500to2000_2016_JEC1_output.root')
)
