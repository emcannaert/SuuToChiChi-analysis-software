...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2016H/JetHT/MINIAOD/UL2016_MiniAODv2-v2/130000/8D2050E5-0F24-544B-A0E3-B187539117D6.root')
)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('clusteringAnalyzer_dataH_2016_nom_output.root')
)
