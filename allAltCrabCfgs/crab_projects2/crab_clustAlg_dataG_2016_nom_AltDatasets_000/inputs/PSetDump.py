...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2016G/JetHT/MINIAOD/UL2016_MiniAODv2-v2/140000/003C0002-F991-6E48-8E96-2C4FD9EA8E3B.root')
)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('clusteringAnalyzer_dataG_2016_nom_output.root')
)
