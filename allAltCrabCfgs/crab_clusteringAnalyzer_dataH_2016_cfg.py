...
config = config()
config.General.requestName = 'clustAlg_dataH_2016_nom_AltDatasets_000'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.JobType.allowUndistributedCMSSW = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '../allCfgs/clusteringAnalyzer_dataH_2016_cfg.py'
...
config.Data.outputDatasetTag = 'clustAlg_dataH_2016_nom'
