...
config = config()
config.General.requestName = 'clustAlg_TTbarMC_2016__AltDatasets_000'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.JobType.allowUndistributedCMSSW = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '../allCfgs/clusteringAnalyzer_TTbarMC_2016_cfg.py'
...
config.Data.outputDatasetTag = 'clustAlg_TTbarMC_2016_'
