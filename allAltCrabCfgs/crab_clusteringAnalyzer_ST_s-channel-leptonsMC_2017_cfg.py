...
config = config()
config.General.requestName = 'clustAlg_ST_s-channel-leptonsMC_2017_nom_AltDatasets_000'
...
config.Data.outputDatasetTag = 'clustAlg_ST_s-channel-leptonsMC_2017_nom'
