...
do
	...
	do
		...
		hadd -f TTbarMC_combined_${year}_${systematic}_CUTFLOW.root TTJetsMCHT1200to2500_${year}_${systematic}_CUTFLOW.root TTJetsMCHT2500toInf_${year}_${systematic}_CUTFLOW.root
