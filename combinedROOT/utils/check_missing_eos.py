...
if __name__ == "__main__":
	...
	with open("../txt_files/all_combined_eos_files.txt",'r') as f:
		all_files_combined = f.readlines()

	with open("../txt_files/all_skimmed_eos_files.txt", 'r') as f:
		all_files_skimmed = f.readlines()

	with open("../txt_files/all_processed_eos_files.txt", 'r') as f:
		all_files_processed = f.readlines()

	with open("../txt_files/all_eos_crab_files.txt",'r') as f:
		all_files_crab = f.readlines()


	with open("../txt_files/all_cutflow_eos_files.txt",'r') as f:
	...
	output_file = open("../txt_files/missing_files.txt",'w')
