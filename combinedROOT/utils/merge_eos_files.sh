...
then 
	...
	python create_eos_copy_commands.py ../txt_files/WW_eos_paths.txt
	source eos_copy_commands.sh
	eosrm $EOSBASE/combinedROOT_temp/WW_MC*_combined_*.root

	echo "Copying ZZ Files"
	python create_eos_copy_commands.py ../txt_files/ZZ_eos_paths.txt
	source eos_copy_commands.sh
	eosrm $EOSBASE/combinedROOT_temp/ZZ_MC*_combined_*.root


	echo "Copying QCD Pt Files"
	python create_eos_copy_commands.py ../txt_files/QCD_Pt_eos_paths.txt
	source eos_copy_commands.sh
	...
	python create_eos_copy_commands.py ../txt_files/WJets_eos_paths.txt
	source eos_copy_commands.sh
	...
	python create_eos_copy_commands.py ../txt_files/TTbar_eos_paths.txt
	source eos_copy_commands.sh
	if source eos_copy_commands.sh; then
	...
	python create_eos_copy_commands.py ../txt_files/QCD_eos_paths.txt
	source eos_copy_commands.sh
	if source eos_copy_commands.sh; then
	...
	python create_eos_copy_commands.py ../txt_files/ST_eos_paths.txt
	source eos_copy_commands.sh
	if source eos_copy_commands.sh; then
	...
	python create_eos_copy_commands.py ../txt_files/data_eos_paths.txt
	if source eos_copy_commands.sh; then
