...
if __name__=="__main__":
	...
	nCommands	= {  "2015": { "QCDMC2000toInf": { 'JEC1':0, 'JEC2':0, 'JER':0,'nom':0  },     #nCommands[year][sample][systematic]
					 ...
					 "QCDMC_Pt_170to300":{ 'JEC1':0, 'JEC2':0, 'JER':0,'nom':0  },
					 "QCDMC_Pt_300to470":{ 'JEC1':0, 'JEC2':0, 'JER':0,'nom':0  },
					 "QCDMC_Pt_470to600":{ 'JEC1':0, 'JEC2':0, 'JER':0,'nom':0  },
					 "QCDMC_Pt_600to800":{ 'JEC1':0, 'JEC2':0, 'JER':0,'nom':0  },
					 "QCDMC_Pt_800to1000":{ 'JEC1':0, 'JEC2':0, 'JER':0,'nom':0  },
					 "QCDMC_Pt_1000to1400":{ 'JEC1':0, 'JEC2':0, 'JER':0,'nom':0  },
					 "QCDMC_Pt_1400to1800":{ 'JEC1':0, 'JEC2':0, 'JER':0,'nom':0  },
					 "QCDMC_Pt_1800to2400":{ 'JEC1':0, 'JEC2':0, 'JER':0,'nom':0  },
					 "QCDMC_Pt_2400to3200":{ 'JEC1':0, 'JEC2':0, 'JER':0,'nom':0  },
					 "QCDMC_Pt_3200toInf":{ 'JEC1':0, 'JEC2':0, 'JER':0,'nom':0  },
	...
	all_files_made	= {  "2015": { "QCDMC2000toInf": { 'JEC1':[], 'JEC2': [], 'JER':[],'nom':[]  },     #nCommands[year][sample][systematic]
					...
					"TTJetsMCHT800to1200":{ 'JEC1':[], 'JEC2': [], 'JER':[],'nom':[] },
					 ...
					 "QCDMC_Pt_170to300":{'JEC1':[], 'JEC2': [], 'JER':[],'nom':[]},
					 "QCDMC_Pt_300to470":{ 'JEC1':[], 'JEC2': [], 'JER':[],'nom':[] },
					 "QCDMC_Pt_470to600":{ 'JEC1':[], 'JEC2': [], 'JER':[],'nom':[] },
					 "QCDMC_Pt_600to800":{ 'JEC1':[], 'JEC2': [], 'JER':[],'nom':[]  },
					 "QCDMC_Pt_800to1000":{ 'JEC1':[], 'JEC2': [], 'JER':[],'nom':[] },
					 "QCDMC_Pt_1000to1400":{ 'JEC1':[], 'JEC2': [], 'JER':[],'nom':[] },
					 "QCDMC_Pt_1400to1800":{ 'JEC1':[], 'JEC2': [], 'JER':[],'nom':[]},
					 "QCDMC_Pt_1800to2400":{ 'JEC1':[], 'JEC2': [], 'JER':[],'nom':[]  },
					 "QCDMC_Pt_2400to3200":{'JEC1':[], 'JEC2': [], 'JER':[],'nom':[] },
					 "QCDMC_Pt_3200toInf":{ 'JEC1':[], 'JEC2': [], 'JER':[],'nom':[] },
