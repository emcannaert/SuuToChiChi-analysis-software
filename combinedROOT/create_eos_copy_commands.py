...
if __name__=="__main__":
	...
	nCommands	= {  "2015": { "QCDMC2000toInf": { 'JEC':0,'JER':0,'nom':0  },     #nCommands[year][sample][systematic]
					 ...
					 "ST_t-channel_antitop":{ 'JEC':0,'JER':0,'nom':0  },
					 "ST_t-channel_top":{ 'JEC':0,'JER':0,'nom':0  },
					 "ST_tW_antitop":{ 'JEC':0,'JER':0,'nom':0  },
					 "ST_tW_top":{ 'JEC':0,'JER':0,'nom':0  }  }, 
	...
	all_files_made	= {  "2015": { "QCDMC2000toInf": { 'JEC':[],'JER':[],'nom':[]  },     #nCommands[year][sample][systematic]
					 ...
					 "ST_t-channel_antitop":{ 'JEC':[],'JER':[],'nom':[]  },
					 "ST_t-channel_top":{ 'JEC':[],'JER':[],'nom':[]  },
					 "ST_tW_antitop":{ 'JEC':[],'JER':[],'nom':[]  },
					 "ST_tW_top":{ 'JEC':[],'JER':[],'nom':[]  }  }, 
	...
	samples = ["QCDMC2000toInf","QCDMC1500to2000","QCDMC1000to1500","TTToHadronic", "TTToLeptonic", "TTToSemiLeptonic","ST_t-channel_antitop", "ST_t-channel_top", "ST_tW_antitop","ST_tW_top"]
