...
process.hadronFilter = cms.EDFilter("hadronFilter",
   ...
   runType = cms.string("Suu5_chi1")   #types: QCDMC1000to1500, QCDMC1500to2000, QCDMC2000toInf, TTToHadronicMC, TTToSemiLeptonic, TTToLeptonic, DataA, etc. , Suu8_chi3, etc.
)
process.clusteringAnalyzerAll_JEC_up = cms.EDAnalyzer("clusteringAnalyzerAll",
   runType = cms.string("Suu5_chi1"),   #types: QCDMC1000to1500, QCDMC1500to2000, QCDMC2000toInf, TTbarMC, DataA, etc. , Suu8_chi3, etc.
