...
process.hadronFilter = cms.EDFilter("hadronFilter",
   ...
   systematicType = cms.string("JEC"),
   JECUncert_AK4_path = cms.FileInPath("data/JEC/2016_UL_preAPV/data/Summer19UL16APV_RunBCD_V7_DATA_Uncertainty_AK4PFchs.txt"),
   doPUID = cms.bool(True),
   runType = cms.string("Suu5_chi1p5")   #types: QCDMC1000to1500, QCDMC1500to2000, QCDMC2000toInf, TTToHadronicMC, TTToSemiLeptonic, TTToLeptonic, DataA, etc. , Suu8_chi3, etc.
)
process.clusteringAnalyzerAll_JEC_up = cms.EDAnalyzer("clusteringAnalyzerAll",
   runType = cms.string("Suu5_chi1p5"),   #types: QCDMC1000to1500, QCDMC1500to2000, QCDMC2000toInf, TTbarMC, DataA, etc. , Suu8_chi3, etc.
   ...
   PUfile_path = cms.FileInPath('data/POG/LUM/2016preVFP_UL/puWeights.json'),
