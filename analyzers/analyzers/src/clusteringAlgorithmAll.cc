...

{
   ...
   JECUncert_path = iConfig.getParameter<edm::FileInPath>("JECUncert_path");
...
*/
   ...
   JetCorrectionUncertainty *jecUnc_AK4 = new JetCorrectionUncertainty(JECUncert_path.fullPath().c_str());
